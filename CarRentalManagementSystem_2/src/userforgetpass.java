 ...
 * @author Asus
 */
public class userforgetpass extends javax.swing.JFrame {

    /**
     * Creates new form userforgetpass
     */
 ...
 String email;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            ResultSet rs=select.getData("select *from users2 where email='"+email+"'");
            try
            {
                if(rs.next())
                {
    ...
    private void rSMaterialButtonCircle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle2ActionPerformed
        ...
        {
            ResultSet rs=select.getData("select *from users2 where email ='"+email+"' and securityQuestion='"+securityQuestion+"' and answer='"+answer+"'");
            try
            {
                if(rs.next())
                {
                    ...
                    InsertUpdateDelete.setData("update users2 set password='"+newpassword+"' where email='"+email+"'", "Password Set Successfully");
                    setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(userforgetpass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new userforgetpass().setVisible(true);
            }
        });
    }
